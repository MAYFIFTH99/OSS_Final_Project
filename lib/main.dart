            ...
            Expanded(
              ...
              child: Container(
                ...
                child: Column(
                  ...
                  children: [
                    Text(
                      '저는 기업의 서버 관리를 하는 백엔드 서버 관련 직종을 희망하고 있습니다.\n요즘 대부분의 기업이 백엔드 프레임워크로 자바와 스프링, 스프링 부트, JPA들을 많이 사용하고 있어 인프런에서 스프링 관련 강의를 수강하면서 학습하고 있습니다. \n\n여름 방학동안 스프링 프레임워크와 웹 동작 방식에 대한 이해를 목표로 공부할 계획입니다.\n2학기부터는 팀프로젝트 경험을 쌓아 실무에 필요한 git지식을 학습해 포트폴리오를 완성해 나갈 계획입니다. \n\n도커와 쿠버네티스에 대해 공부해보고자 하는 마음이 있었는데 오픈소스 수업시간을 통해 대괄적인 개념을 이해한 후 학습할 수 있어 여러가지로 도움이 많이 된 수업이었습니다. 감사드립니다',
                      style: TextStyle(fontSize: 16.0),
                    ),
                    SizedBox(height: 10.0),
                  ],
